...
from generate_user_drugs.import_postgres import import_postgres_user_drugs
from generate_user_drugs.import_mysql import import_mysql_user_drugs
from generate_user_drugs.import_mongo import (
    import_mongo_user_drugs,
    get_mongo_operations,
)


def _parse_args():
    parser = argparse.ArgumentParser(description="User drugs import script options")
...
def import_all(records_num):
    ...
    try:
        time_taken_pg = import_postgres_user_drugs(len(records), records)
    ...
    try:
        time_taken_mysql = import_mysql_user_drugs(len(records), records)
